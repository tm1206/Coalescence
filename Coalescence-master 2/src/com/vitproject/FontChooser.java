...
jFace=new JList<String>(fontNames); jFace.setSelectedIndex(0);
...
jStyle=new JList<String>(fontStyles);jStyle.setSelectedIndex(0); 
...
jSize=new JList<String>(fontSizes); jSize.setSelectedIndex(0); 
